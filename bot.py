...
BANNED_WORDS = [
    ...
    "хач","чурка","узкоглазый","москаль","хохол","жиды","негр","ниггер",
    "даун","дауны","дауна","пидики","куколды","куколдов","пидиков","пидоров",
    ...
    "пидорашка","черножопый","чуркобес","ауловец","рашист","инцел","исламист","негренок","пидорюга",
]
